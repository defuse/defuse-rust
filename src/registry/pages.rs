...
pub static PAGE_REGISTRY: LazyLock<HashMap<&'static str, PageInfo>> = LazyLock::new(|| {
    let pages: &[PageInfo] = &[
        ...
        page! {
            ...
            features: Some(Features { banner: None, math: true }),
        },
        page! {
        ...
        page! {
            ...
            features: Some(Features { banner: Some(DEPRECATED_BANNER), math: false }),
        },
        page! {
        ...
        page! {
            ...
            features: Some(Features { banner: Some("<div class=\"deprecated-banner\">This page has been deprecated. The code/information below may no longer be maintained.<br />There&#039;s a new, better version of this tool: <a href=\"/vfy-backup-tester.htm\"><span class=\"monowb\">$ vfy</span> Directory Comparison Tool</a>.</div>"), math: false }),
        },
        page! {
